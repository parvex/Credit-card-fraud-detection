...
neural_net_undersample_workflow <- tune_with_data(neural_net_spec, data_train, undersample_recipe)
...
neural_net_undersample_selected_workflow <- tune_with_data(neural_net_spec, selected_data_train, selected_undersample_recipe)
...
neural_net_oversample_workflow <- tune_with_data(neural_net_spec, data_train, oversample_recipe)
...
neural_net_oversample_selected_workflow <- tune_with_data(neural_net_spec, selected_data_train, selected_oversample_recipe)
